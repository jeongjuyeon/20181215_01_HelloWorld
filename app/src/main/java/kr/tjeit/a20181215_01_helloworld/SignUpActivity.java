...
//        signUpBtn.setText("회원가입");
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SignUpActivity.this, String.format("ID : %s, PW :%s 로 로그인 합니다.", inputUserid, inputUserPw), Toast.LENGTH_LONG).show();

                Log.d(tag:"회원가입시도", msg:"id : "+ inputUserid);
